  ...
  <div class="container">
    <div class="checkout-addr">
          ...
          <ul>
            <li v-for="(item,index) in addressList" :key="index" :class="{'check':checkIndex == index}" @click="checkIndex = index;selectAddressId = item.addressId">
              ...
              <div class="addr-opration addr-set-default">
                <a href="javascript:;" class="addr-set-default-btn" v-if="!item.isDefault" @click="setDefault(item.addressId)"><i>设置地址</i></a>
              </div>
      ...
      <div class="next-btn-wrap">
        ...
        <router-link :to="{path:'orderConfirm',query:{'addressId':selectAddressId}}" class="btn btn--m btn--red">下一步</router-link>
      </div>
    </div>
  </div>
</div>
